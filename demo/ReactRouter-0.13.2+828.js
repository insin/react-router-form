...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Link = __webpack_require__(4);
	exports.NotFoundRoute = __webpack_require__(1);
	exports.Redirect = __webpack_require__(7);
	exports.Route = __webpack_require__(3);
	exports.RouteHandler = __webpack_require__(5);

	exports.HashLocation = __webpack_require__(6);
	exports.HistoryLocation = __webpack_require__(10);
	exports.RefreshLocation = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HistoryLocation = __webpack_require__(10);
	var History = __webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StaticLocation = (function () {
	  function StaticLocation(path, data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Navigation = {
	   ...
	   */
	  transitionTo: deprecatedMethod("transitionTo", function (to, params, query, data) {
	   ...
	   */
	  replaceWith: deprecatedMethod("replaceWith", function (to, params, query, data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HashLocation = __webpack_require__(6);
	var HistoryLocation = __webpack_require__(10);
	var RefreshLocation = __webpack_require__(8);
	...
	function createRouter(options) {
	  ...
	  var Router = React.createClass({
	    ...
	    statics: {
	       ...
	       * a new URL onto the history stack.
	       */
	      transitionTo: function transitionTo(to, params, query, data) {
	        var path = Router.makePath(to, params, query);
	       ...
	       * the current URL in the history stack.
	       */
	      replaceWith: function replaceWith(to, params, query, data) {
	       ...
	       */
	      dispatch: function dispatch(path, action, data) {
	        Router.cancelPendingTransition();
